        ...
        <div className=''>
            ...
            <table className="w-full  mt-5">
                <thead>
                    <tr>
                        ...
                        <th className="w-1/5 text-left p-2">Total</th>
                        <th className=" 1/5 "></th>
                    </tr>
                </thead>
                <tbody>
                    {/* Map through your cart items and render each row */}
                    {cartItems.map((item) => (
                        <tr key={item.id} className='border-b'>
                            <td className=" p-2 ">
                                <div className=' flex flex-col lg:flex-row gap-2 xl:gap-8'>
                                    ...
                                    <h2 className='font-semibold text-sm sm:text-lg text-blue-300 flex items-center'>
                                        {item.name}
                                    </h2>
                                </div>
                            </td>
                            ...
                            <td className=" p-2">
                                <div className='flex space-x-5 items-center'>
                                    ...
                                    <div className='md:flex-row flex md:gap-2 space-y-2 md:space-y-0 flex-col'>
                                        <button className='bg-gray-300 px-3 text-lg'>+</button>
                                        <button className='bg-gray-300 px-3 text-lg'>-</button>
                                    </div>
                            ...
                            <td className=" p-2 pl-5"><button><FontAwesomeIcon icon={faTrash} /></button></td>
            ...
            <div className='mt-5 p-5  md:flex md:flex-row-reverse'>
                <div className='bg-white shadow-md shadow-gray-300 w-full md:w-2/5 p-5 space-y-5 '>
                    ...
                    <button className='p-2 mt-5 rounded-lg border text-lg w-full hover:bg-gray-100 active:bg-gray-500 active:text-white'>
                        Checkout
                    </button>
